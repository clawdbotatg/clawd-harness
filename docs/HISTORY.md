# clawd-harness — the full historical orientation (archived 2026-08-29)

> This is the old `CLAUDE.md`, preserved verbatim. It grew to 67KB of
> feature-by-feature history and war stories — ~17k tokens loaded into every
> session — and was replaced by a lean operative `CLAUDE.md`. Nothing here was
